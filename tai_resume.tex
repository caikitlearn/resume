...
\textbf{Graduate-level training in:} Bayesian statistics (multilevel models, causal inference, model averaging, nonparametric methods), classical statistics (hypothesis testing, mixed models, regularization, asymptotic theory), sushi eating
...
Excel, HTML, CSS, Javascript, git, tmux, whatsapp

\vspace{2mm}

\textbf{Some exposure to:} Keras, TensorFlow, Hadoop, Spark, Scala, Java, SAS, Stata, Tulsa
